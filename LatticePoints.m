% wrapper function of the codes by Dirk Nyuens from
% https://people.cs.kuleuven.be/~dirk.nuyens/fast-cbc/fastrank1pt.m
% From the page we use fastrank1pt.m, generatorp.m, generator.m, powmod.m
...
beta = ones(s_max, 1);
% primes: the nearest prime to 2^n
% Note that we define primes(1):=3
